...
!(function (u, p, s, c) {
			...
			for (var e in t)
				switch (e) {
					...
					case 'rtl':
						;((C.rtl = !!t.rtl),
							Array.from(
								p.getElementsByClassName('clr-field'),
							).forEach(function (e) {
								return e.classList.toggle(
									'clr-rtl',
									C.rtl,
								)
							}))
					...
					case 'formatToggle':
						;((C.formatToggle = !!t.formatToggle),
							(V('clr-format').style.display =
								C.formatToggle ? 'block' : 'none'),
					...
					case 'alpha':
						;((C.alpha = !!t.alpha),
							f.setAttribute('data-alpha', C.alpha))
						break
					case 'inline':
						;((C.inline = !!t.inline),
							f.setAttribute('data-inline', C.inline),
							C.inline &&
								((l = t.defaultColor || C.defaultColor),
								(E = Y(l)),
								j(),
								U(l)))
						break
					case 'clearButton':
						;('object' == typeof t.clearButton &&
							...
							(v.style.display = C.clearButton
								? 'block'
								: 'none'))
						break
					case 'clearLabel':
						;((C.clearLabel = t.clearLabel),
							(v.innerHTML = C.clearLabel))
						break
					case 'closeButton':
						...
						break
					case 'closeLabel':
						;((C.closeLabel = t.closeLabel),
							(m.innerHTML = C.closeLabel))
						break
					case 'a11y':
						var a,
							l,
	...
	function N(e) {
		;(delete o[e],
			0 === Object.keys(o).length && ((B = !1), e === S && O()))
	}
	function t(l) {
		if (B) {
			var e,
	...
	function K(e) {
		var t = {
				pageX: ((a = e).changedTouches ? a.changedTouches[0] : a)
					.pageX,
	...
	;(NodeList !== c &&
		...
		_(function () {
			;((d = c),
				(f = p.createElement('div')).setAttribute(
					'id',
					'clr-picker',
				),
