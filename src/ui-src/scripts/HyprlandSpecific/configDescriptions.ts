export const configDescriptions: {
	...
	},
	{
		...
		data: '5',
		description:
			'gaps between windows supports css style gaps (top, right, bottom, left -> 5 10 15 20)',
	},
	{
		name: 'gaps_out',
		path: 'general',
		...
		data: '20',
		description:
			'gaps between windows and monitor edges supports css style gaps (top, right, bottom, left -> 5 10 15 20)',
	},
	{
		name: 'float_gaps',
		path: 'general',
		...
		data: '0',
		description:
			'gaps between windows and monitor edges for floating windows supports css style gaps (top, right, bottom, left -> 5 10 15 20). -1 means default gaps_in/gaps_out 0 means no gaps',
	},
	{
	...
	},
	{
		...
		data: 'false',
		description:
			'enable OpenGL debugging and error checking, they hurt performance.',
	},
	{
		name: 'disable_logs',
		path: 'debug',
	...
	},
	{
		...
		data: 'false',
		description:
			'if enabled, bindm movewindow will drop the window more precisely depending on where your mouse is. This feature also turns on preserve_split.',
	},
	{
	...
	},
	{
		...
		data: 'true',
		description:
			'Determines if column focus wraps around when going before the first column or past the last column',
	},
	{
		name: 'wrap_swapcol',
		path: 'scrolling',
		...
		data: 'true',
		description:
			'Determines if column movement wraps around when moving to before the first column or past the last column',
	},
	{
		name: 'prefer_hdr',
		path: 'quirks',
...
for (let item of Array.from(configDescriptions)) {
	if (item['path'] === 'scrolling') {
		console.log(item)
	}
}
