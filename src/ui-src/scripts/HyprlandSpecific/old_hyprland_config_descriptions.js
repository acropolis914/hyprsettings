export const config_descriptions = [
	...
	{
		name: 'new_window_takes_over_fullscreen',
		path: 'misc',
		type: 'CONFIG_OPTION_INT',
		data: '0, 0, 2',
		description:
	...
	{
		name: 'disable_hyprland_qtutils_check',
		path: 'misc',
		type: 'CONFIG_OPTION_BOOL',
		data: 'false',
	...
	},
	{
		...
		description:
			"Enable CM without shader. 0 - disable, 1 - whenever possible, 2 - DS and passthrough only, 3 - don't block DS when non-shader CM isn't available",
	},
	{
		name: 'invisible',
		path: 'cursor',
