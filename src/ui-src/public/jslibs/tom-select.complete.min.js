...
!(function (e, t) {
	...
	const s = (e) => ((e = e.filter(Boolean)).length < 2 ? e[0] || '' : 1 == l(e) ? '[' + e.join('') + ']' : '(?:' + e.join('|') + ')'),
		i = (e) => {
	...
	class T {
		...
		tokenize(e, t, s) {
			...
			var o
			return (
				s && (o = new RegExp('^(' + Object.keys(s).map(r).join('|') + '):(.*)$')),
				n.forEach((e) => {
					let s,
						n = null,
						l = null
					;(o && (s = e.match(o)) && ((n = s[1]), (e = s[2])),
						e.length > 0 && ((l = this.settings.diacritics ? I(e) || null : r(e)), l && t && (l = '\\b' + l)),
						i.push({
							string: e,
		...
		_getSortFunction(e) {
			...
			return s.length
				? function (e, t) {
						var i, n
						for (let o of s) {
							if (((n = o.field), (i = ('desc' === o.direction ? -1 : 1) * E(r(n, e), r(n, t))))) return i
						}
						return 0
					}
				: null
		...
		prepareSearch(e, t) {
			...
			if ((F(i, 'sort'), F(i, 'sort_empty'), i.fields)) {
				...
				const e = []
				;(i.fields.forEach((t) => {
					;('string' == typeof t && (t = { field: t, weight: 1 }), e.push(t), (s[t.field] = 'weight' in t ? t.weight : 1))
				}),
					(i.fields = e))
			}
			return {
		...
		search(e, t) {
			...
			e.length
				? L(n.items, (e, n) => {
						;((s = o(e)), (!1 === t.filter || s > 0) && i.items.push({ score: s, id: n }))
					})
				: L(n.items, (e, t) => {
	...
	const P = (e) => (null == e ? null : N(e)),
		...
		j = (e) => (e + '').replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;'),
		$ = (e, t) => {
			var s
			return function (i, n) {
				var o = this
		...
		H = (e, t) => !!t && !!t[e] && 1 === (t.altKey ? 1 : 0) + (t.ctrlKey ? 1 : 0) + (t.shiftKey ? 1 : 0) + (t.metaKey ? 1 : 0),
		R = (e, t) => {
						...
						;((p.maxItems = e.hasAttribute('multiple') ? null : 1),
							B(e.children, (e) => {
								...
								'optgroup' === (t = e.tagName.toLowerCase())
									? (((n = f((s = e)))[a] = n[a] || s.getAttribute('label') || ''),
										(n[c] = n[c] || h++),
										(n[r] = n[r] || s.disabled),
										(n.$order = n.$order || ++g),
										p.optgroups.push(n),
	...
	class ce extends (function (e) {
		return (
			...
			class extends e {
				...
				initializePlugins(e) {
					...
					if (Array.isArray(e))
						e.forEach((e) => {
							'string' == typeof e ? n.push(e) : ((i.plugins.settings[e.name] = e.options), n.push(e.name))
						})
		...
		constructor(e, t) {
			...
			;((this.settings = n),
				...
				(this.sifter = new T(this.options, {
			...
			;('function' != typeof o &&
				...
				o instanceof RegExp
					...
					: (n.createFilter = (e) => this.settings.duplicates || !this.options[e])),
			...
			if (
				...
				p = K(n.controlInput)
				;(B(['autocorrect', 'autocapitalize', 'autocomplete', 'spellcheck'], (e) => {
		...
		setupTemplates() {
			var e = this,
				...
				i = {
					...
					optgroup_header: (e, t) => '<div class="optgroup-header">' + t(e[s]) + '</div>',
		...
		onKeyPress(e) {
			...
			if (!t.isLocked) {
				...
				return t.settings.create && 'multi' === t.settings.mode && s === t.settings.delimiter
		...
		onKeyDown(e) {
			...
			if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && q(e)
				...
				switch (e.keyCode) {
					case 65:
						if (H(oe, e) && '' == t.control_input.value) return (q(e), void t.selectAll())
						break
					case 27:
					...
					case 13:
						return void (t.canSelect(t.activeOption)
							...
							: ((t.settings.create && t.createItem()) || (document.activeElement == t.control_input && t.isOpen)) &&
								q(e))
					case 37:
					...
					case 9:
						return void (
							...
							(t.canSelect(t.activeOption) && (t.onOptionSelect(e, t.activeOption), q(e)),
			...
			this.lastValue !== t &&
				...
				'' != t
					? (this.refreshTimeout && window.clearTimeout(this.refreshTimeout),
						(this.refreshTimeout = ((e, t) => (t > 0 ? window.setTimeout(e, t) : (e.call(null), null)))(() => {
			...
			;(t.parentElement && t.parentElement.matches('[data-disabled]')) ||
				(t.classList.contains('create')
					...
					: void 0 !== (s = t.dataset.value) &&
						...
						i.addItem(s),
						i.settings.closeAfterSelect && i.close(),
						!i.settings.hideSelected && e.type && /click/.test(e.type) && i.setActiveOption(t)))
		}
		canSelect(e) {
					...
					for (
						l = a.getLastActive(),
							(n = Array.prototype.indexOf.call(a.control.children, l)) >
								(o = Array.prototype.indexOf.call(a.control.children, e)) && ((r = n), (n = o), (o = r)),
							i = n;
						i <= o;
						i++
					)
						((e = a.control.children[i]), -1 === a.activeItems.indexOf(e) && a.setActiveItemClass(e))
					q(t)
				} else
		...
		clearActiveOption() {
			;(this.activeOption && (W(this.activeOption, 'active'), se(this.activeOption, { 'aria-selected': null })),
				(this.activeOption = null),
		...
		inputState() {
			...
			e.control.contains(e.control_input) &&
				...
				e.activeItems.length > 0 || (!e.isFocused && e.settings.hidePlaceholder && e.items.length > 0)
					...
					: (e.settings.hidePlaceholder && e.items.length > 0 && se(e.control_input, { placeholder: '' }),
						(e.isInputHidden = !1)),
		...
		search(e) {
			...
			if (i.settings.score && 'function' != typeof (s = i.settings.score.call(i, e)))
				throw new Error('Tom Select "score" setting must be a function that returns a function')
			return (
				e !== i.lastQuery
					? ((i.lastQuery = e), (t = i.sifter.search(e, Object.assign(n, { score: s }))), (i.currentResults = t))
			...
			for (t = 0; t < n; t++) {
				...
				for (
					...
					;(s > 0 &&
						...
						W(d, 'active'),
						h.activeOption && h.activeOption.dataset.value == n && c && c.dataset.group === o.toString() && (v = d)),
						a.appendChild(d),
						'' != o && (u[o] = i))
				}
			}
		...
		removeItem(e = null, t) {
			...
			;((i = te(e)),
				e.remove(),
				e.classList.contains('active') && ((n = s.activeItems.indexOf(e)), s.activeItems.splice(n, 1), W(e, 'active')),
				s.items.splice(i, 1),
				(s.lastQuery = null),
				!s.settings.persist && s.userOptions.hasOwnProperty(o) && s.removeOption(o, t),
			...
			if (t.is_select_tag) {
				...
				;(t.input.querySelectorAll('option:checked').forEach((e) => {
					...
					0 == t.items.length && 'single' == t.settings.mode
						? l(n, '', '')
						: t.items.forEach((e) => {
								if (((s = t.options[e]), (i = s[t.settings.labelField] || ''), o.includes(s.$option))) {
									l(t.input.querySelector(`option[value="${M(e)}"]:not(:checked)`), e, i)
				...
				n.inputValue().length ||
					(H(oe, t) || H('shiftKey', t)
						? (i = (s = n.getLastActive(e))
							...
							(i.classList.contains('active') && n.removeActiveItem(s), n.setActiveItemClass(i))
						: n.moveCaret(e)))
		}
		moveCaret(e) {}
		getLastActive(e) {
			...
			if (
				...
				'option' === e || 'option_create' === e
					...
					: 'optgroup' === e &&
						...
						se(i, { 'data-group': s }),
						t.group[n.settings.disabledField] && se(i, { 'data-disabled': '' })),
				'option' === e || 'item' === e)
			) {
				...
				;(se(i, { 'data-value': s }),
					'item' === e
						...
						: (J(i, n.settings.optionClass), se(i, { role: 'option', id: t.$id }), (t.$div = i), (n.options[s] = t)))
			}
			return i
		}
		_render(e, t) {
		...
		hook(e, t, s) {
			...
			i[t] = function () {
				...
				return (
					...
					'instead' === e ? o : ('before' === e && (t = n.apply(i, arguments)), t)
				)
			}
		}
	}
	return (
		...
		ce.define('checkbox_options', function (e) {
			...
			var n = function (e, t) {
					t
						? ((e.checked = !0),
							i.uncheckedClassNames && e.classList.remove(...i.uncheckedClassNames),
							i.checkedClassNames && e.classList.add(...i.checkedClassNames))
						: ((e.checked = !1),
							i.checkedClassNames && e.classList.remove(...i.checkedClassNames),
							i.uncheckedClassNames && e.classList.add(...i.uncheckedClassNames))
				},
				o = function (e) {
					setTimeout(() => {
			...
			;(t.hook('after', 'setupTemplates', () => {
				...
				t.hook('instead', 'onOptionSelect', (e, i) => {
					if (i.classList.contains('selected'))
						return (i.classList.remove('selected'), t.removeItem(i.dataset.value), t.refreshOptions(), void q(e, !0))
					;(s.call(t, e, i), o(i))
				}))
		}),
						...
						a = (e, t) => {
							...
							void 0 !== t &&
								(((e, t) => {
									...
									? ((i = t), null == (n = (s = e).parentNode) || n.insertBefore(i, s.nextSibling))
									: ((e, t) => {
											var s
				...
				;('single' !== e.settings.mode && e.control.contains(e.control_input)
					? (t = Math.max(0, Math.min(e.items.length, t))) == e.caretPos ||
						...
						e.controlChildren().forEach((s, i) => {
							i < t ? e.control_input.insertAdjacentElement('beforebegin', s) : e.control.appendChild(s)
						})
					: (t = e.items.length),
					(e.caretPos = t))
			}),
			...
			e.hook('instead', 'onKeyDown', (s) => {
				...
				;((e.ignoreHover = !0),
					...
					r &&
						...
						(n = (o = r.querySelectorAll('[data-selectable]'))[Math.min(o.length - 1, i)]) &&
						e.setActiveOption(n))
			})
		}),
						...
						return (
							...
							D(r, 'click', (e) => {
								s.isLocked ||
									(q(e, !0),
									s.isLocked ||
										(s.shouldDelete([o], e) && (s.removeItem(o), s.refreshOptions(!1), s.inputState())))
							}),
							o
						)
					}
		...
		ce.define('virtual_scroll', function () {
			...
			const c = (t) =>
					!('number' == typeof e.settings.maxOptions && n.children.length >= e.settings.maxOptions) && !(!(t in r) || !r[t]),
			...
			;((e.setNextUrl = (e, t) => {
				...
				e.hook('after', 'refreshOptions', () => {
					...
					var s
					;(c(t)
						? (s = e.render('loading_more', { query: t })) && (s.setAttribute('data-selectable', ''), (o = s))
						: t in r &&
							!n.querySelector('.no-results') &&
							(s = e.render('no_more_results', {
								query: t,
							})),
