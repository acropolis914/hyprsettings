export const config_descriptions = [
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "0",
    "description": "gaps between windows and monitor edges for floating windowssupports css style gaps (top, right, bottom, left -> 5 10 15 20). -1 means default  gaps_in/gaps_out0 means no gaps"
  },
  {
