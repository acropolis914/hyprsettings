...
Otherwise, you can try configuring niri to render on the discrete GPU via the [`render-drm-device`](./Configuration:-Debug-Options#render-drm-device) debug option.
...
See the [window effects](./Window-Effects) wiki page.
