export const configDescriptions: {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "0",
    "description": "gaps between windows and monitor edges for floating windowssupports css style gaps (top, right, bottom, left -> 5 10 15 20).-1 means defaultgaps_in/gaps_out 0 means no gaps"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "if enabled, floating windows will ignore tiled windows in their blur. Only available if blur_new_optimizations is true. Will reduce overhead on floatingblur significantly."
  },
  {
    "name": "noise",
    "path": "decoration:blur",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "",
    "description": "Sets the cursor acceleration profile. Can be one of adaptive, flat. Can also be custom, see below. Leave empty to use libinput's default mode for yourinput device. [adaptive/flat/custom]"
  },
  {
    "name": "force_no_accel",
    "path": "input",
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "Force no cursor acceleration. This bypasses most of your pointer settings to get as raw of a signal as possible. Enabling this is not recommended due topotential cursor desynchronization."
  },
  {
    "name": "rotation",
    "path": "input",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "If the scroll button lock is enabled, the button does not need to be held down. Pressing and releasing the button toggles the button lock, which logicallyholds the button down or releases it. While the button is logically held down, motion events are converted to scroll events."
  },
  {
    "name": "scroll_factor",
    "path": "input",
  ...
  },
  {
    ...
    "data": "0, \"next,cursor\"",
    "description": "Controls the window focus behavior when a window is closed. When set to 0, focus will shift to the next window candidate. When set to 1, focus will shiftto the window under the cursor."
  },
  {
    "name": "mouse_refocus",
    "path": "input",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "1, 0, 2",
    "description": "If enabled (1 or 2), focus will change to the window under the cursor when changing from tiled-to-floating and vice versa. If 2, focus will also followmouse on float-to-float switches."
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "1, 0, 3",
    "description": "Handles axis events around (gaps/border for tiled, dragarea/border for floated) a focused window. 0 ignores axis events 1 sends out-of-bound coordinates 2fakes pointer coordinates to the closest point inside the window 3 warps the cursor to the closest point inside the window"
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "1, 0, 2",
    "description": "Emulates discrete scrolling from high resolution scrolling events. 0 disables it, 1 enables handling of non-standard events only, and 2 force enables allscroll wheel events to be handled"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "Sending LMB and RMB simultaneously will be interpreted as a middle click. This disables any touchpad area that would normally send a middle clickbased on location."
  },
  {
    "name": "tap_button_map",
    "path": "input:touchpad",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "Button presses with 1, 2, or 3 fingers will be mapped to LMB, RMB, and MMB respectively. This disables interpretation of clicks based on location onthe touchpad."
  },
  {
    "name": "tap-to-click",
    "path": "input:touchpad",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "0, 0, 2",
    "description": "When enabled, lifting the finger off while dragging will not drop the dragged item. 0 -> disabled, 1 -> enabled with timeout, 2 -> enabled sticky. dragging will not drop the dragged item."
  },
  {
    "name": "tap-and-drag",
    "path": "input:touchpad",
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "",
    "description": "The class regex to be used for windows that should be swallowed (usually, a terminal). To know more about the list of regex which can be used use thischeatsheet."
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "",
    "description": "The title regex to be used for windows that should not be swallowed by the windows specified in swallow_regex (e.g. wev). The regex is matched against theparent (e.g. Kitty) window’s title on the assumption that it changes to whatever process it’s running."
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "2, 0, 2",
    "description": "if there is a fullscreen or maximized window, decide whether a tiled window requested to focus should replace it, stay behind or disable thefullscreen/maximized state. 0 - ignore focus request (keep focus on fullscreen window), 1 - takes over, 2 - unfullscreen/unmaximize [0/1/2]"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "If enabled, workspaces don’t forget their previous workspace, so cycles can be created by switching to the first workspace in a sequence, then endlesslygoing to the previous workspace."
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "0, 0, 1",
    "description": "sets the preferred focus finding method when using focuswindow/movewindow/etc with a direction. 0 - history (recent have priority), 1 - length (longershared edges have priority)"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_INT",
    "data": "0, 0, 2",
    "description": "Enables direct scanout. Direct scanout attempts to reduce lag when there is only one fullscreen application on a screen (e.g. game). It is alsorecommended to set this to false if the fullscreen application shows graphical glitches. 0 - off, 1 - on, 2 - auto (on with content type 'game')"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_STRING_SHORT",
    "data": "default",
    "description": "Default transfer function for displaying SDR apps. default - Use default value (Gamma 2.2), gamma22 - Treat unspecified as Gamma 2.2, gamma22force - Treatunspecified and sRGB as Gamma 2.2, srgb - Treat unspecified as sRGB"
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "true",
    "description": "sync xcursor theme with gsettings, it applies cursor-theme and cursor-size on theme load to gsettings making most CSD gtk based clients use same xcursortheme and size."
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "false",
    "description": "if enabled, allows a more precise control over the window split direction based on the cursor's position. The window is conceptually divided into fourtriangles, and cursor's triangle determines the split direction. This feature also turns on preserve_split."
  },
  {
    "name": "smart_resizing",
    "path": "dwindle",
    "type": "CONFIG_OPTION_BOOL",
    "data": "true",
    "description": "if enabled, resizing direction will be determined by the mouse's position on the window (nearest to which corner). Else, it is based on the window'stiling position."
  },
  {
  ...
  },
  {
    ...
    "type": "CONFIG_OPTION_BOOL",
    "data": "true",
    "description": "when enabled, dragging and dropping windows will put them at the cursor position. Otherwise, when dropped at the stack side, they will go to thetop/bottom of the stack depending on new_on_top."
  },
  {
  ...
  },
  {
    ...
    "path": "scrolling",
    "type": "CONFIG_OPTION_CHOICE",
    "data": ".firstIndex = 0, .choices = \"center,fit\"",
  ...
  },
  {
    ...
    "path": "scrolling",
    "type": "CONFIG_OPTION_CHOICE",
    "data": ".firstIndex = 0, .choices = \"right,left,down,up\"",
...
// Autogenerated from ConfigDescriptions0.54
